...
const EmployerZone = () => {
  ...
  return (
    <section id="employerzone" className="bg-neutral-900 text-white py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate__animated animate__fadeIn">
          <h2 className="text-4xl font-bold mb-4">Employer Zone</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate__animated animate__fadeInRight">
            <div className="bg-neutral-800 rounded-xl p-8">
              <h3 className="text-2xl font-bold mb-6">Post Your Requirement</h3>
